...
<img src=./images/pic2.gif /> <input type="submit" name="fight" value="Attaquer" /><br /><br />
<img src=./images/pic2.gif /><select name="userspell"><option value="0">Les Sorts</option>$magiclist</select><input type="submit" name="spell" value="Exécuter" /><br /><br />
<img src=./images/pic2.gif /> <input type="submit" name="run" value="Fuir le combat" /><br /><br />
</form>
END;
...
function drop() {
    ...
    if (isset($_POST["submit"])) {
        ...
        $page = "L'objet a été équipé. Vous pouvez maintenant continuer à <a href=\"index.php\">explorer le monde</a>.</center> ";
    ...
    $page .= "<form action=\"index.php?do=drop\" method=\"post\"><select name=\"slot\"><option value=\"0\">Les Fentes</option><option value=\"1\">Fente 1: ".$userrow["slot1name"]."</option><option value=\"2\">Fente 2: ".$userrow["slot2name"]."</option><option value=\"3\">Fente 3: ".$userrow["slot3name"]."</option></select> <input type=\"submit\" name=\"submit\" value=\"Valider\" /></form>";
    $page .= "Vous pouvez également choisir de continuer à <a href=\"index.php\">explorer le monde</a> et renoncer à cet objet.";
